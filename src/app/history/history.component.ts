...
export class HistoryComponent {
  ...
  history = [
    {
      url: '../../assets/images/picture_7.webp',
    ...
    {
      url: '../../assets/images/picture_9.webp',
  ...
  images = [
    {
      img: 'assets/images/picture_7.webp',
      text: 'Хвиля репресій зачепила 40 квартир із 66. Розстріляні — 33 особи, заслані на довгі роки — 3, померли в засланні — 2, наклали на себе руки — 1, убиті/померли за незрозумілих обставин — 1.',
    },
    {
      img: 'assets/images/picture_9.webp',
      text: 'Репресії проти української інтелігенції мали цілеспрямований характер. Радянська влада бажала знищити українську національну свідомість та встановити тотальний контроль над усіма сферами життя.',
    },
  ];
  ...
  items: any[] = [
    {
      url: '../../assets/images/picture_3.webp',
      title:
    ...
    {
      url: '../../assets/images/picrure_4.webp',
      description:
  ...
  items1: any[] = [
    {
      url: '../../assets/images/picture_6.webp',
      description:
